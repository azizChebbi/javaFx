...
import com.bitalm.schoolpresence.chatting.ClientHandler;
...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        String s = "Mohamed Aziz Chebbi" ;
        String[] ss= new String[2];ss[0] = "aziz" ;
        System.out.println("are they equal: "+s.equals(ss[0])) ;
